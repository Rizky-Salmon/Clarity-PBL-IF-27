        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="h3 mx-1">Activity</div>

                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="dropdown">
                            <button class="btn btn-outline-dark dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Représentation institutionelle

                            </button>
                            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="#">Go To The Moon</a>
                                <a class="dropdown-item" href="#">Go To The Sky</a>
                                <a class="dropdown-item" href="#">Visiting Hogwarts</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <h1 class="text-center">Représentation institutionelle</h1>
                                    <div>
